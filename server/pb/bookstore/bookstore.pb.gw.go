...
func request_BookStore_Status_0(ctx context.Context, marshaler runtime.Marshaler, client BookStoreClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq Empty
...
func local_request_BookStore_Status_0(ctx context.Context, marshaler runtime.Marshaler, server BookStoreServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq Empty
	var metadata runtime.ServerMetadata
...
func RegisterBookStoreHandlerServer(ctx context.Context, mux *runtime.ServeMux, server BookStoreServer) error {
	...
	mux.Handle("GET", pattern_BookStore_Status_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		ctx, cancel := context.WithCancel(req.Context())
		defer cancel()
		var stream runtime.ServerTransportStream
		ctx = grpc.NewContextWithServerTransportStream(ctx, &stream)
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		rctx, err := runtime.AnnotateIncomingContext(ctx, mux, req, "/bookstore.BookStore/Status", runtime.WithHTTPPathPattern("/bookstore.BookStore/Status"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := local_request_BookStore_Status_0(rctx, inboundMarshaler, server, req, pathParams)
		...
		forward_BookStore_Status_0(ctx, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
...
func RegisterBookStoreHandlerClient(ctx context.Context, mux *runtime.ServeMux, client BookStoreClient) error {
	...
	mux.Handle("GET", pattern_BookStore_Status_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		defer cancel()
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		rctx, err := runtime.AnnotateContext(ctx, mux, req, "/bookstore.BookStore/Status", runtime.WithHTTPPathPattern("/bookstore.BookStore/Status"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := request_BookStore_Status_0(rctx, inboundMarshaler, client, req, pathParams)
		ctx = runtime.NewServerMetadataContext(ctx, md)
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
...
var (
	pattern_BookStore_Status_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1}, []string{"bookstore.BookStore", "Status"}, ""))
)

var (
	forward_BookStore_Status_0 = runtime.ForwardResponseMessage
)
